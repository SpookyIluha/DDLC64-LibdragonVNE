...
void libdragon_logo()
{
    ...
    sprite_t *d1 = sprite_load("rom:/images/intro/dragon1.i8.sprite");
    sprite_t *d2 = sprite_load("rom:/images/intro/dragon2.i8.sprite");
    sprite_t *d3 = sprite_load("rom:/images/intro/dragon3.i8.sprite");
    sprite_t *d4 = sprite_load("rom:/images/intro/dragon4.i8.sprite");
    wav64_t music;
    wav64_open(&music, "rom:/bgm/dragon.wav64");
